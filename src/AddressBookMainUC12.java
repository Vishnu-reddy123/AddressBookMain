...
public class AddressBookMainUC12 {
    ...
    public void sortByCityStateZip() {
        ...
        List<ContactDetails> result = null;
        switch (choice) {
            case 1 -> result = addressBook.stream().sorted(
                    Comparator.comparing(ContactDetails::getCity)).collect(Collectors.toList());
            case 2 -> result = addressBook.stream().sorted(
                    Comparator.comparing(ContactDetails::getState)).collect(Collectors.toList());
            case 3 -> result = addressBook.stream().sorted(
                    Comparator.comparing(ContactDetails::getZipCode)).collect(Collectors.toList());
    ...
    //Provided person details
    {
        ...
        addressBook.add(new ContactDetails("Sai", "Krishna", "Bengaluru", "Bengaluru", "Karnataka", 789456, 9632145696L));
        addressBook.add(new ContactDetails("Bharat", "Kalinga", "Pune", "pune", "Maharashtra", 987654, 8978978979L));
        addressBook1.add(new ContactDetails("Aditya", "Choudhary", "Vizag", "Vizag", "Andhra Pradesh", 456456, 9156874527L));
        addressBook1.add(new ContactDetails("Tabriz", "Shaikh", "Hyderabad", "Hyderabad", "Telangana", 369258, 9321356488L));
        addressBook1.add(new ContactDetails("Tilak", "Varma", "Mumbai", "Mumbai", "Maharashtra", 123456, 7741258926L));
    ...
    public static void main(String[] args) {
        ...
        AddressBookMainUC12 addressBookMain = new AddressBookMainUC12();
