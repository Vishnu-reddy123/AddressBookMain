...
public class AddressBookMainUC9 {
    ...
    //Provided person details
    {
        ...
        addressBook1.add(new ContactDetails("Tabriz", "Shaikh", "Hyderabad", "Hyderabaf", "Telangana", 369258, 9321356488L));
    ...
    public static void main(String[] args) {
        ...
        AddressBookMainUC9 addressBookMain = new AddressBookMainUC9();
